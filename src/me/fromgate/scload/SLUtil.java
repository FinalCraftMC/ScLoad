...
public class SLUtil extends FGUtilCore implements CommandExecutor, Listener {
	ScLoad plg;
	public SLUtil(ScLoad plugin, boolean vcheck, boolean savelng, String language, String devbukkitname, String version_name, String plgcmd, String px){
	...
	private boolean executeCmd(CommandSender sender, String cmd, String fn,String wn,String xs,String ys,String zs) {
		if (cmd.equalsIgnoreCase("load")){
			...
			SLQueue q = new SLQueue (plg,w,v,fn);
	...
	private boolean executeCmd(CommandSender sender,String cmd, String arg) {
		if (cmd.equalsIgnoreCase("load")){
			...
			SLQueue q = new SLQueue (plg,p.getWorld(),new Vector (p.getLocation().getBlockX(),p.getLocation().getBlockY(),p.getLocation().getBlockZ()),arg);
